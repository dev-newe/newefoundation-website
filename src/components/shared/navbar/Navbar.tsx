...
const Navbar = async () => {
  ...
  return (
    <header className="sticky top-0 z-50 m-4 flex items-center justify-center overflow-hidden rounded-xl shadow-md">
      <div className="mx-auto flex w-full items-center justify-between bg-white/60 px-6 py-2.5 shadow-xs backdrop-blur-sm dark:bg-gray-950/80">
        {/* Brand Logo */}
        <BrandLogo
